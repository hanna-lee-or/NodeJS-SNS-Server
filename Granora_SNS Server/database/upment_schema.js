...
Schema.createSchema = function(mongoose) {
	...
	// 댓글 스키마 정의
	var UpmentSchema = mongoose.Schema({
		// 해당 게시글 아이디
	...
	UpmentSchema.static('findByID', function(post_id, callback) {
		return this.find({post_id: post_id}, callback);
	});
	
	UpmentSchema.static('findAll', function(callback) {
		return this.find({}, callback);
	});
	
	console.log('UpmentSchema 정의함.');
